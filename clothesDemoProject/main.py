...
class BaseUser(BaseModel):
    ...
    # Doing it above with class method for validating
    # @validator("email")
...
@app.post("/clothes/", response_model=ClothesOut, dependencies=[Depends(oauth2_scheme), Depends(is_admin)], status_code=201)
